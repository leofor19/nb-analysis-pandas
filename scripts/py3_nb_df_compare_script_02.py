...
#out_path = "C:/Users/leofo/OneDrive - McGill University/Narrow Band Data1/Analysis/{}/Comps Means/".format(datetime.now().strftime("%Y_%m_%d"))
out_path = "C:/Users/leofo/OneDrive - McGill University/Narrow Band Data1/Analysis/{}/Comps Decl Means/".format(datetime.now().strftime("%Y_%m_%d"))
...
# Type of pairwise comparison function:
...
if __name__ == "__main__":
    ...
    dfcomp.save_pairwise_comparisons(df, out_path = out_path, different_attRF = different_attRF, different_attLO = different_attLO, between_phantoms = between_phantoms,
                                        correction = correction, save_format = file_format, ftype = ftype)
